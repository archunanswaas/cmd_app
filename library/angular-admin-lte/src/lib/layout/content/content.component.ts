...
export class ContentComponent implements OnInit, OnDestroy {
  ...
  public HeaderShareService:any;
  public hshshs:string;
  ...
  ngOnInit() {
    ...
    //this.hshshs = this.HeaderShareService.getTitle();
    //console.log(this.hshshs);
    //this.Shareheader = data['title'];
   
    //console.log(this.HeaderShareService);
  ...
  getHeaderTitle(callback: (data) => void ){

     return this.routingService.onChange.subscribe((value: any) => {
