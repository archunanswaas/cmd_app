export const adminLteConf = {
  ...
  sidebarLeftMenu: [
    ...
    {label: 'Dashboard 1', route: '/', iconClasses: 'fa fa-road', pullRights: [{text: '', classes: 'label pull-right bg-green'}]},
    {label: 'Dashboard 2', route: 'dashboard-2', iconClasses: 'fa fa-road', pullRights: [{text: '', classes: 'label pull-right bg-green'}]},
    {label: 'RMS', route: 'rms', iconClasses: 'fa fa-road', pullRights: [{text: '', classes: 'label pull-right bg-green'}]},
